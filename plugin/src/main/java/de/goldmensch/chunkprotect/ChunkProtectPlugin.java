...
public class ChunkProtectPlugin extends SmartPlugin {
  ...
  public void onEnable() {
    ...
    getServer().getServicesManager()
        .register(ChunkProtect.class, new ApiChunkProtect(this), this, ServicePriority.High);
  }
  ...
  private void initMessenger() {
    messenger = SafeExceptions.safeIOException(this, () -> Messenger.setupMessenger(this,
        getConfigFile().getLocalization().isMiniMessage(),
        getConfigFile().getLocalization().isUseActionBar()));
  }
