...
import de.goldmensch.chunkprotect.commands.subs.HelpSub;
import de.goldmensch.chunkprotect.commands.subs.InfoSub;
import de.goldmensch.chunkprotect.commands.subs.TrustSub;
import de.goldmensch.chunkprotect.commands.subs.UnclaimAllSub;
import de.goldmensch.chunkprotect.commands.subs.UnclaimSub;
import de.goldmensch.chunkprotect.commands.subs.UntrustSub;
...
public class ChunkProtectCommand extends SmartCommand {
  ...
  @Override
  public boolean noSubFound(String[] strings, CommandSender commandSender, Command command,
                            String s) {
  ...
  @Override
  public void wrongExecutorLevel(ArgValuedSubCommand argValuedSubCommand,
  ...
  public void noPermission(ArgValuedSubCommand argValuedSubCommand, CommandSender commandSender) {
    String msg = chunkProtectPlugin.getServer().spigot().getPaperConfig()
        .getString("messages.no-permission");
    commandSender.sendMessage(LegacyComponentSerializer.legacyAmpersand()
        .deserialize(msg != null ? msg : "no message found"));
  }
