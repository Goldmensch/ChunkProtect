...
public final class Chunks {
  ...
  public static boolean hasAccess(ClaimedChunk chunk, UUID holder) {
    return chunk.getTrustedPlayer().contains(holder)
        || chunk.getHolderUUID().equals(holder) || chunk.getHolder().getTrustedAllChunks()
        .contains(holder);
  }
  ...
  public static boolean isClaimedAndHolder(ClaimableChunk chunk, Player sender,
                                           ChunkProtectPlugin protect) {
